...
public class NMapViewer extends NMapActivity {
	...
	// private static final String API_KEY = "71280b009af2cc10af3a1f125cef5e05";	// for com.nhn.android.mapviewer
	private static final String API_KEY = "acb25db1ebc8e6cf41b5a1056f860d21";	// for com.access.sel.parking
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (USE_XML_LAYOUT) {
			setContentView(R.layout.nhn_mapview_main);
